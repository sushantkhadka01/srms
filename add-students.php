...
<div class="col-sm-10">
<input type="text" name="fullanme" class="form-control" id="fullanme" onblur="validateAlphabets(this)" required="required" autocomplete="off">
...
<div class="form-group">
      ...
      var inputField = document.getElementById('fullanme');
      var alphabetPattern = /^[a-zA-Z]+$/;
      console.log(inputField)

      if (alphabetPattern.test(inputField.value)) {
        console.log('Valid input: Only alphabets allowed');
      ...
      var inputField = document.getElementById('rollid');
      var numericPattern = /^[0-9]+$/;

      if (numericPattern.test(inputField.value)) {
        console.log('Valid input: Only numeric values allowed');
        // Continue with form submission or other actions
      } else {
